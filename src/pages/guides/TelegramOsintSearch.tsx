  ...
  sections: [
    {
      ...
      content: (
        <>
          ...
          <p>FootprintIQ — Ethical Digital Footprint Intelligence Platform — includes Telegram scanning as part of its <Link to="/scan" className="text-primary hover:underline font-medium">multi-platform exposure assessment</Link>, helping users understand what their Telegram presence reveals to anyone who searches for them.</p>
        </>
      ),
    },
    {
