      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="py-16 bg-muted/20">
          <div className="max-w-4xl mx-auto px-6 prose prose-lg dark:prose-invert">
            ...
            <p>Start with a <Link to="/scan" className="text-primary hover:underline">free scan</Link> to see what's publicly discoverable about any Instagram handle across the entire web. Use our <Link to="/usernames" className="text-primary hover:underline">username search tool</Link> for multi-platform enumeration, try a <Link to="/reverse-username-search" className="text-primary hover:underline">reverse username lookup</Link>, run the <Link to="/digital-footprint-checker" className="text-primary hover:underline">digital footprint checker</Link> for a complete exposure assessment, or explore the <Link to="/username-search-engine" className="text-primary hover:underline">username search engine</Link>.</p>
          </div>
        </section>
