...
const faqs = [
  {
    question: "How do I remove my profile from BeenVerified?",
    answer:
      "Visit BeenVerified's opt-out page at beenverified.com/app/optout, search for your listing, select your profile, and submit the removal request. You'll receive a verification email — click the link to confirm. Removal typically completes within 24 hours to 7 days.",
  },
  {
    question: "Does BeenVerified have to delete my data under GDPR?",
    answer:
      "If you are a resident of the EU/EEA or the UK, you have the right to request erasure of your personal data under Article 17 of the GDPR. BeenVerified must respond within 30 days. If they fail to comply, you can escalate to your local data protection authority.",
  },
  {
    question: "Can I remove my BeenVerified profile under CCPA?",
    answer:
      "Yes. If you are a California resident, the California Consumer Privacy Act (CCPA) grants you the right to request deletion of your personal information. BeenVerified is required to honour verified requests within 45 days.",
  },
  {
    question: "Will my BeenVerified profile come back after removal?",
    answer:
      "It is possible. BeenVerified aggregates data from public records, court filings, and other sources. New data may cause your profile to be re-created over time. Periodic monitoring and re-submission of removal requests may be necessary.",
  },
  {
    question: "What information does BeenVerified collect about me?",
    answer:
      "BeenVerified may display your name, age, addresses (current and previous), phone numbers, email addresses, social media profiles, relatives, criminal records, court filings, property records, and vehicle information. All data comes from publicly available sources.",
  },
  {
    question: "How long does BeenVerified take to process a removal request?",
    answer:
...
const articleJsonLd = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "How to Remove Your BeenVerified Profile (Step-by-Step Guide)",
  description:
    "Step-by-step guide to removing your BeenVerified listing. Includes GDPR/CCPA template and opt-out instructions.",
  author: {
    "@type": "Organization",
    name: "FootprintIQ",
  ...
  url: "https://footprintiq.app/remove-beenverified-profile",
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Remove BeenVerified Profile", item: "https://footprintiq.app/remove-beenverified-profile" },
  ],
};

const webPageSchema = buildWebPageSchema({
  name: "How to Remove Your BeenVerified Profile (Step-by-Step Guide)",
  description: "Step-by-step guide to removing your BeenVerified listing. Includes GDPR/CCPA template and opt-out instructions.",
  url: "https://footprintiq.app/remove-beenverified-profile",
});

export default function RemoveBeenVerifiedProfile() {
  return (
    <>
      <Helmet>
        <title>How to Remove Your BeenVerified Profile (Step-by-Step Guide)</title>
        <meta
          name="description"
          content="Step-by-step guide to removing your BeenVerified listing. Includes GDPR/CCPA template and opt-out instructions."
        />
        <link rel="canonical" href="https://footprintiq.app/remove-beenverified-profile" />
        <meta property="og:title" content="How to Remove Your BeenVerified Profile (Step-by-Step Guide)" />
        <meta property="og:description" content="Step-by-step guide to removing your BeenVerified listing. Includes GDPR/CCPA template and opt-out instructions." />
        <meta property="og:url" content="https://footprintiq.app/remove-beenverified-profile" />
        ...
        <meta name="twitter:title" content="How to Remove Your BeenVerified Profile (Step-by-Step Guide)" />
        <meta name="twitter:description" content="Step-by-step guide to removing your BeenVerified listing. Includes GDPR/CCPA template and opt-out instructions." />
      </Helmet>
      ...
      <main className="min-h-screen bg-background">
        ...
        <nav aria-label="Breadcrumb" className="max-w-4xl mx-auto px-6 pt-8">
          <ol className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <li>/</li>
            <li className="text-foreground font-medium">Remove BeenVerified Profile</li>
          </ol>
        </nav>
        ...
        <article className="max-w-4xl mx-auto px-6 py-12">
          ...
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              How to Remove Your BeenVerified Profile
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed">
              A step-by-step guide to removing your listing from BeenVerified.com using the online opt-out form, GDPR, or CCPA requests.
            </p>
          </header>

          {/* Section: What Is BeenVerified */}
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <Globe className="w-6 h-6 text-accent" />
              <h2 className="text-2xl font-bold">What Is BeenVerified?</h2>
            </div>
            <div className="bg-card border border-border/50 rounded-2xl p-6 space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                BeenVerified is a people-search service that compiles personal information from public records, court filings, social media profiles, property records, and other publicly accessible data sources to create detailed background reports.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Founded in 2007, BeenVerified is one of the most popular background check platforms in the United States. It is commonly used by individuals, employers, and landlords to look up personal details about people.
              </p>
            </div>
          </section>

          {/* Section: What Data BeenVerified Shows */}
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <FileText className="w-6 h-6 text-accent" />
              <h2 className="text-2xl font-bold">What Data Does BeenVerified Display?</h2>
            </div>
            <div className="bg-card border border-border/50 rounded-2xl p-6 space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                A BeenVerified report may contain some or all of the following publicly sourced information:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <li>Criminal records and court filings</li>
              ...
              <div className="mt-4 p-4 bg-muted/30 rounded-lg border border-border/30">
                <p className="text-sm text-muted-foreground">
                  <strong>Note:</strong> BeenVerified sources this data from publicly accessible records. The accuracy and completeness of reports varies. FootprintIQ's <Link to="/privacy-centre" className="text-accent hover:underline">Privacy Centre</Link> can help you identify which data brokers hold your information.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-card border border-border/50 rounded-2xl p-6 space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                BeenVerified provides a self-service opt-out page. Follow these steps:
              </p>
              <ol className="list-decimal list-inside space-y-3 text-muted-foreground">
                <li>Visit <strong>beenverified.com/app/optout</strong>.</li>
                <li>Search for your name and select your state to find your listing.</li>
                <li>Identify your profile from the search results and click to select it.</li>
                <li>Enter your email address — BeenVerified will send a verification email.</li>
                <li>Click the confirmation link in the email to complete the opt-out.</li>
                <li>Your listing should be removed within 24 hours to 7 days.</li>
              </ol>
              <div className="mt-4 p-4 bg-muted/30 rounded-lg border border-border/30">
                <p className="text-sm text-muted-foreground">
                  <strong>Tip:</strong> If you have multiple BeenVerified profiles (e.g., for different addresses or name variations), you may need to submit separate opt-out requests for each one.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-card border border-border/50 rounded-2xl p-6 space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Send a written request to BeenVerified's privacy team. Include:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                <li>Your full name and the URL of your BeenVerified profile (if available)</li>
              ...
              <div className="mt-6 p-6 bg-muted/20 rounded-xl border border-border/50">
                ...
                <div className="text-sm text-muted-foreground space-y-2 font-mono bg-background/50 p-4 rounded-lg">
                  ...
                  <p className="mt-2">Dear BeenVerified Privacy Team,</p>
                  ...
                  <p className="mt-1 text-accent">[Insert your BeenVerified profile URL or identifying details]</p>
              ...
              <div className="mt-4 p-4 bg-accent/5 rounded-lg border border-accent/20">
                <p className="text-sm text-muted-foreground">
                  FootprintIQ's <Link to="/privacy-centre" className="text-accent hover:underline">Privacy Centre</Link> can generate a GDPR removal template pre-filled with your details for brokers like BeenVerified.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-card border border-border/50 rounded-2xl p-6 space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                California residents have the right to request deletion of personal information under the California Consumer Privacy Act (CCPA). BeenVerified must process verified requests within 45 days.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Your request should include:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                <li>Your full name and profile URL (if available)</li>
