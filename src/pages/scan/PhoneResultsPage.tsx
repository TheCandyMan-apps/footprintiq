  ...
  return (
    <ScanErrorBoundary context="results">
      <div className="min-h-screen flex flex-col bg-background">
        <Helmet>
          <title>Phone Scan Results - FootprintIQ</title>
          <meta name="description" content="View your phone number scan results in real-time" />
        </Helmet>
        
        <Header />
        
        <main className="flex-1 container mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 pb-[calc(env(safe-area-inset-bottom,0px)+96px)] md:pb-8">
