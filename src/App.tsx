...
const OsintForInvestigators = lazy(() => import("./pages/OsintForInvestigators"));
...
const ForProtectedUsers = lazy(() => import("./pages/ForProtectedUsers"));
    ...
    <>
      ...
      <Suspense fallback={<LoadingState />}>
        <PageTransition>
          ...
          <Route path="/what-is-a-digital-footprint" element={<WhatIsDigitalFootprintEducational />} />
           ...
           <Route path="/username-checker" element={<UsernameChecker />} />
            ...
            <Route path="/find-social-media-accounts" element={<FindSocialMediaAccounts />} />
             ...
             <Route path="/how-to-monitor-your-online-exposure-after-a-breach" element={<MonitorOnlineExposureAfterBreach />} />
             ...
             <Route path="/osint-for-investigators" element={<OsintForInvestigators />} />
          ...
          <Route path="/for-protected-users" element={<ForProtectedUsers />} />
