...
interface ToolLandingTemplateProps {
  entry: ContentEntry;
  /** Additional sections to render between How It Works and FAQs */
  children?: React.ReactNode;
}

const DEMO_USERNAME = "alex_m";

export function ToolLandingTemplate({ entry, children }: ToolLandingTemplateProps) {
        ...
        <div className="max-w-3xl mx-auto">
          <ContentBreadcrumb
            items={[
              ...
              { label: entry.title.split(" – ")[0].split(" | ")[0] },
            ]}
          />
          ...
          <section className="mb-16">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { step: "1", title: "Enter a username", desc: "Type any handle into the search box above." },
                { step: "2", title: "Multi-tool scan", desc: "FootprintIQ queries 500+ platforms using Maigret, Sherlock, and other OSINT tools." },
                { step: "3", title: "False-positive filtering", desc: "AI-powered filters remove coincidental matches and low-confidence results." },
                { step: "4", title: "Clear results", desc: "View matched profiles, exposure indicators, and actionable next steps." },
              ].map((item) => (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  bypass authentication, or access private accounts. All scans follow our{" "}
