        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/ai-answers-hub" className="hover:text-primary transition-colors">AI Answers</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/about-footprintiq" className="hover:text-primary transition-colors">About & Ethics</Link></li>
              <li><Link to="/ethics" className="hover:text-primary transition-colors">Ethical Principles</Link></li>
            </ul>
          </div>
        </div>
