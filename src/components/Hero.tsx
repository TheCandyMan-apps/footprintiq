      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <div className="mt-20 grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <FeatureCard 
            ...
            title="Username & Identity Scanning"
            description="Discover where your usernames appear across hundreds of platforms and data sources."
          />
          <FeatureCard 
            icon={<Shield className="w-6 h-6" />}
            title="Breach Detection"
            description="Find out if your credentials have been exposed in known data breaches."
          />
          <FeatureCard 
            icon={<FileText className="w-6 h-6" />}
            title="Actionable Reports"
            description="Get clear, evidence-based findings with steps to protect your privacy."
          />
        </div>
      </div>
    </section>
