...
export const toolRoutes: SitemapEntry[] = [
  ...
  { path: "/platforms/tiktok/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/platforms/reddit/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/platforms/github/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/platforms/telegram/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/platforms/discord/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/platforms/snapchat/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/platforms/youtube/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/platforms/facebook/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/platforms/linkedin/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/platforms/x-twitter/username-search", lastmod: BUILD_DATE, priority: 0.7 },
  // Search [platform] username pages
  { path: "/search-instagram-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-reddit-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-tiktok-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-discord-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-youtube-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-twitter-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-telegram-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-snapchat-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-twitch-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-pinterest-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-github-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-steam-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-tumblr-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-quora-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-medium-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-behance-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-dribbble-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-stackoverflow-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-vk-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-weibo-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-soundcloud-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-mixcloud-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-onlyfans-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-kick-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-rumble-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-threads-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-mastodon-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-substack-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-producthunt-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-hackernews-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-flickr-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-deviantart-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-patreon-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-bandcamp-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-keybase-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-roblox-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-minecraft-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-chess-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-lastfm-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-spotify-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-linkedin-username", lastmod: BUILD_DATE, priority: 0.7 },
  { path: "/search-wordpress-username", lastmod: BUILD_DATE, priority: 0.7 },
  // Legacy platform paths kept for crawl coverage (redirect in app)
  ...
  // Comparisons (canonical paths)
  { path: "/comparisons/sherlock", lastmod: BUILD_DATE },
  { path: "/comparisons/maigret", lastmod: BUILD_DATE },
  { path: "/comparisons/spiderfoot", lastmod: BUILD_DATE },
  { path: "/comparisons/namechk", lastmod: BUILD_DATE },
  { path: "/comparisons/pimeyes", lastmod: BUILD_DATE },
  // Legacy comparisons
