...
export const platformPages: PlatformEntry[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How do I find someone on TikTok by username?", a: "Enter the username into FootprintIQ's search tool. The platform checks whether the handle exists on TikTok and simultaneously scans 500+ other platforms for matching accounts." },
      ...
      { q: "Can TikTok usernames appear in data breaches?", a: "If your TikTok username was part of a breach alongside other data, it may appear in breach databases. FootprintIQ's pipeline includes breach-related sources where applicable." },
      { q: "What platforms are checked alongside TikTok?", a: "FootprintIQ checks over 500 platforms including Instagram, Snapchat, Discord, Reddit, Twitter/X, YouTube, GitHub, Telegram, gaming networks, and forums." },
    ],
